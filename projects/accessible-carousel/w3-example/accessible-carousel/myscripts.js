...
var myCarousel = (function() {
  ...
  function init(set) {
    ...
    ctrls.innerHTML = '<li>' +
      '<button type="button" class="btn-prev"><img alt="Previous Item" src="chevron-left-75c7dd0b.png" /></button>' +
      '</li>' +
      '<li>' +
      '<button type="button" class="btn-next"><img alt="Next Item" src="chevron-right-2f19bc8b.png" /> </button>' +
      '</li>';
